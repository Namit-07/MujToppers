...
const years = [
  ...
  },
  {
    ...
    icon: "🎓",
    title: "4th Year",
    image: "/Images/FOURTHYEAR%20.png",
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 sm:px-6 lg:px-0">
        ...
        <section className="flex flex-col gap-5 text-center lg:max-w-3xl lg:text-left">
          <h1 className="text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">
            ...
            <span className="text-[#ff6a00] animate-fade-in">MECHATRONICS </span>
            <span className="text-zinc-900">Years</span>
          </h1>
          <p className="text-sm leading-relaxed text-zinc-600 sm:text-base">
            Pick your year and dive into curated mechatronics engineering study resources, notes, and more.
          </p>
        </section>
